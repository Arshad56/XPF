({
    ...
    handleInputClick: function(component, event, helper) {
        ...
        console.log('isEmpty-->'+$A.util.isEmpty(component.get('v.filter')));
        if(!$A.util.isEmpty(component.get('v.filter'))){
            ...
            helper.getRecordsByFilter(component, event, helper);
            //component.set('v.openMenu',true);
            //console.log('get Comp222-->'+component.get('v.openMenu'));
        }else{
